...
public class Mail {  
    ...
    private String FROM_ADDRESS = "lianmarius92@gmail.com";  
    private String PASSWORD = "oosp5ukt";  
...
//Meldingen blir nå sendt fra min(Marius) mail. lage en egen mail til healthy catering?
//klassen må brukes slik:
//
//public class Main {  
//  
//    public static void main(String[] args) {  
//        String[] recipients = new String[]{"Mailadresse@lol.knis"};  
//        String[] bccRecipients = new String[]{"Mailadresse@lol.knis"};  
//        String subject = "EMNE HER";  
//        String messageBody = "DET MELDINGEN FAKTSIK SKAL VÆRE";  
//  
